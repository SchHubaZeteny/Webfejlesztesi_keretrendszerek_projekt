...
export class LoginComponent {
  ...
  login() {
    if (this.email.invalid) {
      this.loginError = 'Kérlek adj meg egy email címet!';
      return;
    }
      ...
      .catch(error => {
        ...
        switch(error.code) {
          case 'auth/user-not-found':
            this.loginError = 'Nem található felhasználó ilyen email címmel.';
            break;
          ...
          case 'auth/invalid-credential':
            ...
            break;
          default:
            this.loginError = 'Hibás bejelentkezés. Kérlek próbálkozz később.';
        }
      });
  }
